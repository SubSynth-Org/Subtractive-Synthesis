...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright YourName, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/MyTestPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyTestPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyTestPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyTestPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyTestPlugin-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyTestPlugin-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MyTestPlugin-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MyTestPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MyTestPlugin.iss",inplace=1):
